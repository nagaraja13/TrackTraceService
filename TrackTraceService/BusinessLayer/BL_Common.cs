...
namespace BusinessLayer
{
    ...
    public class BL_Common
    {
        ...
        public string getTable(string strQuery, string strUsername)
        {
            ...
            try
            {
                return "0~" + BL_Common.dataTableToString(objSql.ExecuteDataset(SqlDataLayer.strLocal, strQuery).Tables[0]);
            }
            catch (Exception ex)
            {
                return "1~" + objSql.getErrorMsg(ex.ToString());
        ...
        public string getField(string strQuery, string strUsername)
        {
            ...
            try
            {
                return "0~" + objSql.ExecuteScalarString(SqlDataLayer.strLocal, strQuery);
            }
            catch (Exception ex)
            {
                return "1~" + objSql.getErrorMsg(ex.ToString());
